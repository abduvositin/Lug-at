...
import com.abduvosit.devoloper.lugat.databinding.FragmentYodlanganBinding
import com.abduvosit.devoloper.lugat.shared.SettingsManager
import com.abduvosit.devoloper.lugat.sql.DatabaseHelper

class YodlanganFragment : Fragment() {

    private var _binding: FragmentYodlanganBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentYodlanganBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupRecyclerView() {
        ...
        adapter = WordAdapter(emptyList(), dbHelper, isShowingMemorized = true, longLang = longLang)
    ...
    private fun loadMemorizedWords() {
        val wordList = dbHelper.getMemorizedWords()
